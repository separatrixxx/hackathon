...
class Two_gis():
    ...
    def get_food(self,city,coordinates):
...
class Two_gis_sorted():
    ...
    def get_food(self,city,coordinates):
        ...
        for i in range(len(items)):
            items_type=items[i]
            address_name.append(items_type['address_name'])
            response_coordinates=requests.get(f'https://catalog.api.2gis.com/3.0/items/geocode?q={city},{address_name[i]}, 25&fields=items.point&key={self.key}')
            result_coordinates=response_coordinates.json()['result']
            items_coordinates=result_coordinates['items']
            for j in range(len(items_coordinates)):
                items_coordinates_type=items_coordinates[j]
    ...
    def get_hostel(self,city,coordinates):
        coordinates=coordinates.split(sep=',')
    ...
    def get_petrol(self,city,coordinates):
    ...
    def get_camping(self,city,coordinates):
    ...
    def get_sight(self,city,coordinates):
    ...
    def get_bank(self,city,coordinates):
...
#test=Two_gis_sorted()
#print(test.get_food('Санкт-Петербург','59.849331,30.402235'))