...
function Header() {
    return (
        <div className="flex justify-start p-5">
            <input id="city_from" className="block shadow-inner w-28 md:w-64 h-8 md:h-10 rounded-full pl-2 md:pl-5 p-1
            ...
            <input id="city_to" className="block shadow-inner w-28 md:w-64 h-8 md:h-10 rounded-full pl-2 md:pl-5 p-1
            focus:outline-none text-gray-800 focus:border-sky-400 focus:ring-2 hover:ring-2 ring-1 ring-sky-400
